...
import 'package:marketplace/ui/widgets/item_grid_view.dart';
...
class _ItemlistScreenState extends State<ItemlistScreen> {
  ...
  final List<Map<String, String>> items = [
    ...
    },
    {
      ...
      "discount": "-20%",
      "tavsilod":
          "A bag (also known regionally as a sack)animal skin, cotton, or woven plant fibers, folded up at the edges and secured in that shape with strings of the same material.[1] Bags can be used to carry items such as personal belongings, groceries, and other objects. They comes in various shapes and sizes, often equipped with handles or straps for easier carrying."
    }
  ];
